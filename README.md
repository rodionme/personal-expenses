...
### Deliverables
Application should be delivered via link to a Github repository. Repository should contain `README.md` file with 
instructions on how to build and run an application.
